<!-- AUTO-GENERATED — do not edit. Source: https://github.com/jhnnsrs/fluss-server-next/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`fluss_server/configuration.py`](https://github.com/jhnnsrs/fluss-server-next/blob/next/fluss_server/configuration.py); this file documents it
...
3. **The YAML file** — [`config.yaml`](https://github.com/jhnnsrs/fluss-server-next/blob/next/config.yaml) by default.
