<!-- AUTO-GENERATED — do not edit. Source: https://github.com/jhnnsrs/elektro-server/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`elektro_server/configuration.py`](https://github.com/jhnnsrs/elektro-server/blob/next/elektro_server/configuration.py); this file documents
...
3. **The YAML file** — [`config.yaml`](https://github.com/jhnnsrs/elektro-server/blob/next/config.yaml) by default.
