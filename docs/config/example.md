<!-- AUTO-GENERATED — do not edit. Source: https://github.com/jhnnsrs/example-server/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`example_server/configuration.py`](https://github.com/jhnnsrs/example-server/blob/next/example_server/configuration.py); this file
...
3. **The YAML file** — [`config.yaml`](https://github.com/jhnnsrs/example-server/blob/next/config.yaml) by default.
