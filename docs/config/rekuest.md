<!-- AUTO-GENERATED — do not edit. Source: https://github.com/jhnnsrs/rekuest-server-next/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`rekuest/configuration.py`](https://github.com/jhnnsrs/rekuest-server-next/blob/next/rekuest/configuration.py); this file documents it for
...
3. **The YAML file** — [`config.yaml`](https://github.com/jhnnsrs/rekuest-server-next/blob/next/config.yaml) by default.
