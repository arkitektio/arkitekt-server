<!-- AUTO-GENERATED — do not edit. Source: https://github.com/arkitektio/omero-ark-server/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`omero_ark/configuration.py`](https://github.com/arkitektio/omero-ark-server/blob/next/omero_ark/configuration.py); this file documents it for
...
3. **The YAML file** — [`config.yaml`](https://github.com/arkitektio/omero-ark-server/blob/next/config.yaml) by default.
