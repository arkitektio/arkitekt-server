<!-- AUTO-GENERATED — do not edit. Source: https://github.com/arkitektio/kabinet-server/blob/next/CONFIG.md. Run scripts/sync_config_docs.py to update. -->
...
[`kabinet_server/configuration.py`](https://github.com/arkitektio/kabinet-server/blob/next/kabinet_server/configuration.py); this file documents it
...
3. **The YAML file** — [`config.yaml`](https://github.com/arkitektio/kabinet-server/blob/next/config.yaml) by default.
